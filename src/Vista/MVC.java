...
public void setVisible(boolean visible) {
   ...
   private void createCharts() {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Papeleria.jpg"))); // NOI18N
        ...
        jLabel4.setText("CopyAmigo punto de venta " +new SimpleDateFormat("dd-MM-yyyy").format(myDate));
