...
public class Ticket {
    ...
    public void print() {
        String directory = "C:\\Users\\Cristhian\\Pictures\\CopyAmigo\\CopyAmigo\\Tickets";
    ...
    public void enviarEmailConPDF(String destinatario, String filePath) {
        ...
        final String username = "electrofashioon03@gmail.com"; // Cambia esto a tu correo de Hotmail
        final String password = "eppr wzhk iblx gdqb"; // Cambia esto a tu contraseña
        ...
        try {
            ...
            message.setSubject("CopyAmigo Ticket de compra");
